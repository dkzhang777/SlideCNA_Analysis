...
```
conda env create -f "[https://github.com/dkzhang777/SlideCNA_Analysis/envs/SlideCNA_env.yml](https://raw.githubusercontent.com/dkzhang777/SlideCNA_Analysis/refs/heads/develop/envs/SlideCNA_env.yml)"
```
...
```
conda env create -f "[https://github.com/dkzhang777/SlideCNA_Analysis/blob/testing/envs/bead_split_env.yml](https://raw.githubusercontent.com/dkzhang777/SlideCNA_Analysis/refs/heads/develop/envs/bead_split_env.yml)"
```
